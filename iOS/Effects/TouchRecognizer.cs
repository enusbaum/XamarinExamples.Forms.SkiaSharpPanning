...
namespace XamarinExamples.Forms.SkiaSharpPanning.iOS.Effects
{
    ...
    class TouchRecognizer : UIGestureRecognizer
    {
        ...
        XamarinExamples.Forms.SkiaSharpPanning.Effects.TouchEffect touchEffect;
        bool capture;
        ...
        public TouchRecognizer(Element element, UIView view, XamarinExamples.Forms.SkiaSharpPanning.Effects.TouchEffect touchEffect)
        {
